...
#                             'The rest is for training')
    ...
    # Save config file
    with open(os.path.join(args.folder, f'{model_name}_args.json'), 'w') as f: #name edit
    ...
    valid_loader = DataLoader(dataset=valid_dataset, batch_size=128, shuffle=False, drop_last=False)
    tqdm.write("Done!")
    ...
    for ep in range(start_epoch, args.epochs):
        ...
        history.to_csv(os.path.join(folder, f'{model_name}_history.csv'), index=False)
